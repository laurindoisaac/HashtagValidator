// src/lib.rs
/*
 * Core library for HashtagValidator
 */
...
#[derive(Debug)]
pub struct HashtagValidatorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HashtagValidatorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HashtagValidator processing");
    
    let mut processor = HashtagValidatorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HashtagValidatorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HashtagValidatorProcessor::new(false);
